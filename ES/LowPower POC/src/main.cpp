...
{
    EXTI->PR = EXTI_PR_PR0; // Reset interrupt flag of EXTI0
    btnFlag = 1;
}
...
int main(void)
{
  ...
  GPIOA->MODER = GPIOA->MODER & ~GPIO_MODER_MODER0_Msk;  // Set MODER0 to 00 (input)
  GPIOA->PUPDR = (GPIOA->PUPDR & ~GPIO_PUPDR_PUPDR0_Msk) | (0b01 << GPIO_PUPDR_PUPDR0_Pos);  // Set PUPDR0 to 01 (pull-up)

  SYSCFG->EXTICR[0] = (SYSCFG->EXTICR[0] & ~SYSCFG_EXTICR1_EXTI0) | (0b0000 << SYSCFG_EXTICR1_EXTI0_Pos); // Set EXTI0 to PA0
